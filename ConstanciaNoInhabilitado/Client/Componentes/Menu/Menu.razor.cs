    ...
    partial class Menu
    {
        ...
        private async Task CargarInformacion()
        {
            ...
            var menuInicial = new List<MenuOpciones> {
                 ...
                 new MenuOpciones {TipoUser = new List<TipoUsuario>{TipoUsuario.Administrador, TipoUsuario.Supervisor ,TipoUsuario.Analista,TipoUsuario.Ninguno } ,TipoMenu = TipoMenu.Catalogo, Image = "img/Menu/7.png", Title ="Ver Inhabilitaciones", Description ="Muestra las inhabilitaciones de un servidor público.", Url ="ConstanciaNoInhabilitado/Admin/VerInhabilitacion"},
